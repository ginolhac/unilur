...
#| include: false
#| label: run examples
quarto::quarto_render(input = "_extensions/unilur/example.qmd",
                      output_file = "docs/example_solution.html")
quarto::quarto_render(input = "_extensions/unilur/example.qmd",
                      pandoc_args = "-M solution: false",
                      output_file = "docs/example_nosolution.html")
```
